...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Kumaresh.</span> I'm a{" "}
        <span className="font-bold">Software developer </span> with{" "}
        <span className="font-bold">less than 1 year </span> Internship and Personal experience. I enjoy
